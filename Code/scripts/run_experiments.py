...
from Code.common import constants
from Code.utils import preprocessing, plotting_utils

if __name__ == '__main__':
    data_folder_path = os.path.join(os.getcwd(),"../Data")
    sample_obs_count=10000
    #Running all the classifiers on a sample of the data to report basic accuracies
    reviews_train, y_train, reviews_test, y_test = preprocessing.load_dataset(constants.DATASET, data_folder_path, display=True)
